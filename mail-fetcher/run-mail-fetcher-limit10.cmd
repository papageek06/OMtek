...
set "LOG_FILE=%SCRIPT_DIR%logs\mail-fetcher.log"

echo [%date% %time%] START reception:principale LIMIT=%LIMIT%>>"%LOG_FILE%"
echo [%date% %time%] START reception:principale LIMIT=%LIMIT%
